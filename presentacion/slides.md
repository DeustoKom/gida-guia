...
<div class="left" style="float:right; width:70%;padding-top:1em;">
Descarga:
...
![](img/modelo-portada.jpg){height="600" style="border:solid 1px var(--dark-gray4);"}
...
![Listado de diferentes versiones del mismo documento](img/nombres-archivos-ejemplo.png)

## {data-background-image="img/words.jpg"}

<div class="fragment" style="color:white;font-size:3em;font-weight:bold;">
<p style="line-height:1em;">Nunca  
<span class="fragment">usar</span>  
<span class="fragment">doble</p>
<div class="fragment">
<span class="iconify" data-icon="mdi:keyboard-return" style="background-color:var(--dark-gray4);border-radius:10px;border-bottom:solid 2px #333;border-right:solid 2px #333"></span>, <span class="iconify" data-icon="mdi:keyboard-tab" style="background-color:var(--dark-gray4);border-radius:10px;border-bottom:solid 2px #333;border-right:solid 2px #333"></span>, <span class="iconify" data-icon="mdi:keyboard-space" style="background-color:var(--dark-gray4);border-radius:10px;border-bottom:solid 2px #333;border-right:solid 2px #333"></span>
</div>
</span>
...
![](img/zotero-libgida.png){width="800"}

---

¡Gracias!

![](img/element.png){width="400"}
